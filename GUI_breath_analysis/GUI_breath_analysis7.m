function varargout = GUI_breath_analysis7(varargin)
% GUI_BREATH_ANALYSIS7 MATLAB code for GUI_breath_analysis7.fig
%      GUI_BREATH_ANALYSIS7, by itself, creates a new GUI_BREATH_ANALYSIS7
...
%      changed accordingly
%
%      H = GUI_BREATH_ANALYSIS7 returns the handle to a new GUI_BREATH_ANALYSIS7 or the handle to
%      the existing singleton*.
%
%      GUI_BREATH_ANALYSIS7('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_BREATH_ANALYSIS7.M with the given input arguments.
%
%      GUI_BREATH_ANALYSIS7('Property','Value',...) creates a new GUI_BREATH_ANALYSIS7 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_breath_analysis7_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_breath_analysis7_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 17-Jun-2015 10:47:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_breath_analysis7_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_breath_analysis7_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_breath_analysis7 is made visible.
function GUI_breath_analysis7_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_breath_analysis7 (see VARARGIN)

% Choose default command line output for GUI_breath_analysis7
handles.output = hObject;
% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUI_breath_analysis7 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_breath_analysis7_OutputFcn(hObject, eventdata, handles) 
...
[filename, pathname] = uigetfile('*.mat', 'Pick a segment');
    if isequal(filename,0) || isequal(pathname,0)
       ...
       elseif strcmp(handles.type(counter),'Intermediate')
           v = 3;
       elseif strcmp(handles.type(counter),'Flattened')
           v = 4;
       else
           v = 5;
       end
...
elseif v==4 
    ...
    handles.type{handles.counter} = 'Low signal';
end
guidata(hObject, handles);
